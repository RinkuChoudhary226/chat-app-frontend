...
export class PersonalDetailsComponent implements OnInit {
  ...
  personalDetailsNotCompleted: boolean = AppComponent.appUser.profileCompletionStatus.isPersonalDetailsCompleted;
  errorMsg : string = "";
  successMsg : string = "";
  ...
  ngOnInit(): void {
    ...
    this.persDtlsDataSubscription = this.profileDataSrv.persDtlsData$.subscribe(respPersDtls => 
      {
        this.userPersDtls = respPersDtls;
        this.dob = this.userPersDtls.dateOfBirth;
      });
    this.profileDataSrv.setMessage("");

    if(this.userPersDtls.profileImgFileId != null && this.userPersDtls.profileImgFileId != "")
    {
      this.fileName = "Update Profile Pic"
    }
    console.log(this.fileName);
    // if(this.userPersDtls.dateOfBirth == null || this.userPersDtls.dateOfBirth == undefined)
    // {
    //   this.personalDtlsFrm.patchValue( {"dob": ""} );
    // }
  }

  ngOnDestroy() : void
  {
    if(this.persDtlsDataSubscription != null)
    {
      this.persDtlsDataSubscription.unsubscribe();
    }
  }
  ...
  updatePersDtls()
  {
    ...
    this.mentorSrv.updateProfile(this.userPersDtls, null, "PersonalDetails").subscribe(response =>
    {
        ...
        // if(true)
        {
          if(!this.personalDetailsNotCompleted)
          {
